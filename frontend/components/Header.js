        ...
        <div className="row_">
          <div className="col-12 topHeader">
            <nav className="navbar navbar-expand-lg">
              ...
              <div className="col-md-4 HeaderSearchBar  d-none d-md-block">
              ...
              {/* header search */}
              <div className="headerTopbar ms-auto_">
              ...
              <div className="extra_nav for_mobile">
                <Notification />
                {loggedIn && (
                  <div className="userCartTab d-flex">
                    <a href="javascript:void(0)" className="iconLinks">
                      <span className="rightMenuBtn ">
                        <svg
                          width={21}
                          height={25}
                          viewBox="0 0 21 25"
                    ...
                    <Link href="/cart" className="iconLinks">
                      {cartTotal > 0 && (
                        <span className="cartCounter"> {cartTotal} </span>
                      )}
                      <span className="rightMenuBtn ">
                        <svg
                          width={33}
              ...
              {loggedIn && (
                <>
                  ...
                  {loggedIn && role === "customer" && (
                    <div className="userCartTab for_desktop mob-flex me-20">
                      <Link href="/customer/my-orders" legacyBehavior>
                        <a class="iconLinks myOrderLink rightMenuBtn">
                          <svg
                            width="21"
                            height="25"
                            viewBox="0 0 21 25"
                      ...
                      <Link href="/customer/wishlist" legacyBehavior>
                        <a className="iconLinks rightMenuBtn">
                          <svg
                            width={27}
                            height={24}
                            viewBox="0 0 27 24"
          ...
          <div className="HeaderSearchBar d-block d-md-none">
