...
import { getAllFaqs } from "@/services/cms";

const Faq = ({ allFaqs }) => {
  return (
    <Layout seoData={{ pageTitle: "Faqs - Noonmar" }}>
      <>
            ...
            <div class="accordion" id="accordionExample">
                  ...
                  <div class="accordion-item" key={faq._id}>
                    <h2 class="accordion-header" id={`heading_${faq.id}`}>
                      <button
                        ...
                        data-bs-target={`#collapse_${faq._id}`}
                        aria-expanded="true"
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                  ...
                  >
                    What if I've already booked, but want to bring additional
                    guests?
                  </button>
                </h2>
                <div
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingFour">
                  ...
                  >
                    What happens if a host wants to collect on their security
                    deposit?
                  </button>
                </h2>
                <div
