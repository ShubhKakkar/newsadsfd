...
const Home = ({ verifyNews, homeData }) => {
  ...
  useEffect(() => {
    console.log(verifyNews, verifyNews.status);
      ...
      <>
        ...
        {mostLatestProducts.length > 0 && (
          <section className="sponsored-section">
            <div className="container">
              <div className="text-start">
                <h2 className="section-heading">{t("Newly Launched Items")}</h2>
              </div>
          ...
          <section className="section-padding features-section">
            <div className="container">
              <div className="text-center">
                <h2 className="section-heading borderhide">Shop by Vendors</h2>
              </div>
