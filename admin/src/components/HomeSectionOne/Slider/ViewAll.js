...
const apiName = "master/home/section-one/sliders";
const titleSingular = "Slider";
const titlePlural = "Section 1 - Sliders";
...
const searchQueryHandler = (
  ...
  return `${apiName}?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
};
