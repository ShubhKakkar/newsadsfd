...
const searchQueryHandler = (
  ...
  return `product-sub-category/all?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&dateFrom=${dateFrom}&dateTo=${dateTo}&id=${recordId}`;
};
...
const ViewAll = (props) => {
  ...
  useEffect(() => {
    ...
    document.title = "Product Sub Categories- Noonmar";
  }, [records_per_page]);
  ...
  useEffect(() => {
    if (responseDelete) {
      ...
      toast.success("Product sub category has been deleted successfully.");
    }
  }, [responseDelete]);
  ...
  const deleteHandler = (id) => {
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        requestDelete("DELETE", "product-sub-category", { id });
  ...
  const changeStatusHandler = (id) => {
    ...
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        requestChangeStatus("PUT", "product-sub-category/status", {
          id,
          status,
        });
      } else if (result.isDismissed) {
  ...
  const pushToEditHandler = (id) => {
    history.push(`/product/sub-category/${recordId}/edit/${id}`);
  };
              ...
              <div className="card card-custom card-stretch card-shadowless">
                <div className="card-header">
                  ...
                  <div className="card-toolbar">
                    ...
                    <Link
                      to={`/product/sub-category/add/${recordId}`}
