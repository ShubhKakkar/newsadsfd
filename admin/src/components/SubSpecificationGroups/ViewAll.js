...
const searchQueryHandler = (
  ...
  return `sub-specification-groups/all?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&dateFrom=${dateFrom}&dateTo=${dateTo}&id=${recordId}`;
};
...
const ViewAll = (props) => {
  ...
  useEffect(() => {
    ...
    document.title = "Sub Specification- Noonmar";
  }, [records_per_page]);
  ...
  useEffect(() => {
    if (responseDelete) {
      ...
      toast.success("sub specification has been deleted successfully.");
    }
  }, [responseDelete]);
  ...
  const deleteHandler = (id) => {
    MySwal.fire({
      title: "Are you sure?",
      text: "You want to delete this sub specification groups ?",
      icon: "warning",
      ...
      if (result.isConfirmed) {
        requestDelete("DELETE", "sub-specification-groups", { id });
  ...
  const changeStatusHandler = (id) => {
    ...
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        requestChangeStatus("PUT", "sub-specification-groups/status", {
          id,
          status,
        });
      } else if (result.isDismissed) {
  ...
  const pushToEditHandler = (id) => {
    history.push(
      `/specification-groups/sub-specification-groups/${recordId}/edit/${id}`
    );
  };

  const pushToViewHandler = (id) => {
    history.push(`/product/sub-category/${recordId}/view/${id}`);
  };
  ...
  return (
    ...
    >
      <Breadcrumb
        title="Sub Specification Groups"
        links={[
          { to: "/", name: "Dashboard" },
          {
              ...
              <div className="card card-custom card-stretch card-shadowless">
                <div className="card-header">
                  ...
                  <div className="card-toolbar">
                    ...
                    <Link
                      to={`/specification-groups/sub-specification-groups/add/${recordId}`}
                      className="btn btn-primary"
                    >
                      Add New Sub Specification
                    </Link>
                  </div>
                </div>
                  ...
                  <div className="dataTables_wrapper ">
                    <Table
                      ...
                      links={[
                        ...
                        //   isLink: false,
                        //   name: "View",
                        //   click: pushToViewHandler,
                        //   title: "View",
                        // to: "/product/sub-category/view",
                        // extraData: true,
                        // },
                        {
                          isLink: false,
                          name: "Edit",
                          click: pushToEditHandler,
                          title: "Edit",
                          // to: "/product/sub-category/edit",
                          // extraData: true,
                        },
