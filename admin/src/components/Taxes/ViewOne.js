...
const ViewOne = (props) => {
  ...
  useEffect(() => {
    requestUserData("GET", `tax/${recordId}`);

    document.title = "View Tax - Noonmar";
  }, []);

  useEffect(() => {
    if (responseUserData) {
      const { countryId, productCategoryId, tax, name, isActive, createdAt } =
      ...
      setUserData([
        ...
        {
          title: "Country Name",
          value: countryId && countryId.name ? countryId.name : "-",
        },
        {
            ...
            <div className="card-header card-header-tabs-line">
              <div className="card-toolbar">
                <ul
                  ...
                  role="tablist"
                >
                  {["Tax Information"].map((data, index) => (
