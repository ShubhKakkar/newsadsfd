...
const searchQueryHandler = (
  ...
  return `registration-field/all?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
};
...
const ViewAll = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Registration Fields- Noonmar";
  }, [records_per_page]);

  useEffect(() => {
    if (response) {
      setSeekers(response.registrationFields);
  ...
  const deleteHandler = (id) => {
    MySwal.fire({
      title: "Are you sure?",
      text: "You want to delete this registration field?",
      icon: "warning",
      ...
      if (result.isConfirmed) {
        requestDelete("DELETE", "registration-field", { id });
  ...
  const changeStatusHandler = (id) => {
    ...
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        requestChangeStatus("PUT", "registration-field/status", {
          id,
          status,
        });
      } else if (result.isDismissed) {
                  ...
                  <div className="dataTables_wrapper ">
                    <Table
                      ...
                      links={[
                        ...
                        // {
                        //   isLink: true,
                        //   to: "/registration-fields/view",
                        //   name: "View",
                        //   extraData: true,
                        // },
                        // {
                        //   isLink: true,
                        //   to: "/registration-fields/edit",
                        //   name: "Edit",
                        //   extraData: true,
                        // },
