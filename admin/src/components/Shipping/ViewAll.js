...
const apiName = "shipping-company";
const titleSingular = "Shipping Company";
const titlePlural = "Shipping Companies";
...
const ViewAll = () => {
  ...
  useEffect(() => {
    if (response) {
      setDataList(response.shippingCompanies);
  ...
  useEffect(() => {
    if (responseDelete) {
      ...
      setDataList(newDataList);
      toast.success("Shipping Company has been deleted successfully.");
    }
  }, [responseDelete]);
  ...
  const deleteHandler = (id) => {
    MySwal.fire({
      title: "Are you sure?",
      text: "You want to delete this shipping company?",
      icon: "warning",
              ...
              <div className="card card-custom card-stretch card-shadowless">
                <div className="card-header">
                  ...
                  <div className="card-toolbar">
                    ...
                    {((roleId === 2 && !!permission["12_181"]) ||
                      roleId == 1) && (
                      <Link
                        to="/shipping-company/add"
