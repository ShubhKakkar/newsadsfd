...
const apiName = "master/inventory-reason";
const titleSingular = "Inventory Reason";
const titlePlural = "Inventory Reasons";
...
const ViewAll = () => {
  ...
  useEffect(() => {
    if (responseDelete) {
      ...
      setDataList(newDataList);
      toast.success("Inventory reason deleted successfully.");
    }
  }, [responseDelete]);

  const fetchMoreData = ({ selected }) => {
    setDataList([]);
    const { isActive, reason, dateFrom, dateTo } = getValues();
              ...
              <div className="card card-custom card-stretch card-shadowless">
                <div className="card-header">
                  ...
                  <div className="card-toolbar">
                    ...
                    {/* {((roleId === 2 && !!permission["17_1"]) ||
                      roleId == 1) && (
                      <Link to="/inventory/add" className="btn btn-primary">
                        Add New {titleSingular}
                      </Link>
                    )} */}
<Link to="/inventory-reason/add" className="btn btn-primary">
                        Add New {titleSingular}
                      </Link>
