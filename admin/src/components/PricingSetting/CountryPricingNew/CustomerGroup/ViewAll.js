...
const ViewCustomerGroups = ({ countryId }) => {
  ...
  // if (type != "customer") {
  //   OBJ_TABLE.country = "countryName";
  //   OBJ_TABLE["created at"] = "createdAt";
  //   OBJ_TABLE.status = "isActive";
  // } else {
  //   OBJ_TABLE["created at"] = "createdAt";
  //   OBJ_TABLE.status = "isActive";
  // }
  ...
  const searchQueryHandler = (
    ...
    return `pricing-new/country/customer-groups?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&dateFrom=${dateFrom}&dateTo=${dateTo}&countryId=${countryId}`;
  };
  ...
  useEffect(() => {
    ...
    document.title =
      type == "customer"
        ...
        : type == "specific"
        ? "Specific Group Pricing - Noonmar"
