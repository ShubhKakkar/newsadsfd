...
const ViewCustomerGroups = ({ countryId }) => {
  ...
  const searchQueryHandler = (
    ...
    return `pricing-new/country/product-groups?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&dateFrom=${dateFrom}&dateTo=${dateTo}&countryId=${countryId}`;
  };
