...
const ViewCustomerGroups = (props) => {
  ...
  const searchQueryHandler = (
    ...
    return `pricing-new/system/product-groups?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&type=${type}&dateFrom=${dateFrom}&dateTo=${dateTo}&parentType=default`;
  };
