...
const searchQueryHandler = (
  ...
  return `pricing-new/system/categories?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
};
...
const ViewAll = () => {
  ...
  const deleteHandler = (id) => {
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        requestDelete("DELETE", "pricing-new/system/category", { id });
  ...
  const changeStatusHandler = (id) => {
    ...
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        requestChangeStatus("PUT", "pricing-new/system/category/status", {
          id,
          status,
        });
      } else if (result.isDismissed) {
                ...
                <div className="card-header">
                  ...
                  <div className="card-toolbar">
                    ...
                    {((roleId === 2 && !!permission["7_2"]) || roleId == 1) && (
                      <Link
                        to="/system-pricing/category/add"
                  ...
                  <div className="dataTables_wrapper ">
                    <Table
                      ...
                      links={[
                        ...
                        {
                          isLink: true,
                          to: "/system-pricing/category/view",
                          name: "View",
                          extraData: true,
                          key: "7_4",
                        },
                        {
                          isLink: true,
                          to: "/system-pricing/category/edit",
                          name: "Edit",
                          extraData: true,
                          key: "7_5",
                        },
