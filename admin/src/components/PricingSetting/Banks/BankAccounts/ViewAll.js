...
const ViewAll = (props) => {
  ...
  useEffect(() => {
    ...
    document.title = "Bank Accounts - Noonmar";
  }, [records_per_page]);

  useEffect(() => {
    if (response) {
      setSeekers(response.bankAccounts);
  ...
  const searchQueryHandler = (
    ...
    return `bank-account/${id}?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&dateFrom=${dateFrom}&dateTo=${dateTo}&role=customer`;
  };
  ...
  const deleteHandler = (id) => {
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        requestDelete("DELETE", "bank-account", { id });
  ...
  const changeStatusHandler = (id) => {
    ...
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        requestChangeStatus("PUT", "bank-account/status", {
          id,
          status,
        });
      } else if (result.isDismissed) {
              ...
              <div className="card card-custom card-stretch card-shadowless">
                <div className="card-header">
                  ...
                  <div className="card-toolbar">
                    ...
                    <Link
                      to={`/pricing-setting/bank/account/add/${id}`}
                  ...
                  <div className="dataTables_wrapper ">
                    <Table
                      ...
                      links={[
                        ...
                        {
                          isLink: true,
                          to: `/pricing-setting/bank/account/view/${id}`,
                          name: "View",
                          extraData: true,
                          key: "20_25",
                        },
                        {
                          isLink: true,
                          to: `/pricing-setting/bank/account/edit/${id}`,
                          name: "Edit",
                          extraData: true,
                          key: "20_25",
                        },
