...
const searchQueryHandler = (
  ...
  return `language/all?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&dateFrom=${dateFrom}&dateTo=${dateTo}&role=customer`;
};
...
const ViewAll = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Languages - Noonmar";
  }, [records_per_page]);
  ...
  const deleteHandler = (id) => {
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        requestDelete("DELETE", "language", { id });
  ...
  const changeStatusHandler = (id) => {
    ...
    if (user.language === "English") {
      toast.success("You can't change default language status.");
      return;
    }
    ...
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        requestChangeStatus("PUT", "language/status", {
          id,
          status,
        });
      } else if (result.isDismissed) {
  ...
  return (
    <div
      ...
      id="kt_content"
    >
      <Breadcrumb title="Languages" links={[{ to: "/", name: "Dashboard" }]} />
              ...
              <div className="card card-custom card-stretch card-shadowless">
                <div className="card-header">
                  ...
                  <div className="card-toolbar">
                    ...
                    {/* <Link to="/language/add" className="btn btn-primary">
                      Add New Language
                    </Link> */}
                  </div>
                </div>
