...
const apiName = "currency";
const titleSingular = "Currency";
const titlePlural = "Currencies";
...
const ViewAll = () => {
  ...
  useEffect(() => {
    if (response) {
      setDataList(response.currencies);
                ...
                <div className="card-header">
                  ...
                  <div className="card-toolbar">
                    ...
                    {((roleId === 2 && !!permission["12_181"]) ||
                      roleId == 1) && (
                      <Link to="/currency/add" className="btn btn-primary">
