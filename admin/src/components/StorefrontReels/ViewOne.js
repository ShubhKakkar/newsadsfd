...
const ViewOne = (props) => {
  ...
  useEffect(() => {
    ...
    document.title = "View Storefront Reel - Noonmar";
  }, []);

  useEffect(() => {
    if (responseData) {
      const { video, status,user, createdAt } =  responseData.data;
      setRecord([
            ...
            <div className="card-header card-header-tabs-line">
              <div className="card-toolbar">
                <ul
                  ...
                  role="tablist"
                >
                  {["Storefront Reel Information"].map((data, index) => (
