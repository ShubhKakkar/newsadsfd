...
const ViewOne = (props) => {
  ...
  useEffect(() => {
    requestUserData("GET", `manufacture/${recordId}`);

    document.title = "View Manufacture - Noonmar";
  }, []);
  ...
  useEffect(() => {
    if (responseUserData) {
      ...
      setUserData([
        ...
        // {
        //     title: "Vendor",
        //     value: vendor && vendor.businessName ? vendor.businessName : "-",
        // },
        {
          title: "Brand",
          value: brands.length > 0 ? brands.map((b) => b.name).join(", ") : "-",
        },
        {
          title: "Created At",
            ...
            <div className="card-header card-header-tabs-line">
              <div className="card-toolbar">
                <ul
                  ...
                  role="tablist"
                >
                  {["Manufacture Information"].map((data, index) => (
