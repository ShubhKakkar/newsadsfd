...
const searchQueryHandler = (
  ...
  return `requested-category/?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&name=${name}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
};
...
const ViewAll = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Requested Category - Noonmar";
  }, [records_per_page]);
  ...
  const deleteHandler = (id) => {
    MySwal.fire({
      title: "Are you sure?",
      text: "You want to delete this requested category?",
      icon: "warning",
      ...
      if (result.isConfirmed) {
        requestDelete("DELETE", "requested-category", { id });
