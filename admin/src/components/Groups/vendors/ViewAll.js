...
const searchQueryHandler = (
  ...
  return `group/all/vendor?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&members=${members}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
};
...
const ViewAll = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Vendor Groups - Noonmar";
  }, [records_per_page]);
              ...
              <div className="card card-custom card-stretch card-shadowless">
                <div className="card-header">
                  ...
                  <div className="card-toolbar">
                    ...
                    {/* {((roleId === 2 && !!permission["18_2"]) ||
                      roleId == 1) && (
                      <Link to="/group/vendor/add" className="btn btn-primary">
                        Add New Group
                      </Link>
                    )} */}
                    <Link to="/group/vendor/add" className="btn btn-primary">
