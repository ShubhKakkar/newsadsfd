...
const searchQueryHandler = (
  ...
  return `group/all/supplier?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&members=${members}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
};
...
const ViewAll = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Supplier Groups - Noonmar";
  }, [records_per_page]);
              ...
              <div className="card card-custom card-stretch card-shadowless">
                <div className="card-header">
                  ...
                  <div className="card-toolbar">
                    ...
                    {((roleId === 2 && !!permission["18_10"]) ||
                      roleId == 1) && (
                      <Link
                        to="/group/supplier/add"
