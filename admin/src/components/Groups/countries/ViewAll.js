...
const searchQueryHandler = (
  ...
  return `group/all/country?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&members=${members}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
};
...
const ViewAll = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Country Groups - Noonmar";
  }, [records_per_page]);
  ...
  useEffect(() => {
    if (responseDelete) {
      ...
      toast.success("Country Group deleted successfully.");
    }
  }, [responseDelete]);
  ...
  return (
    <div
      ...
      id="kt_content"
    >
      <Breadcrumb title="Country Groups" links={[{ to: "/", name: "Dashboard" }]} />
              ...
              <div className="card card-custom card-stretch card-shadowless">
                <div className="card-header">
                  ...
                  <div className="card-toolbar">
                    ...
                    {((roleId === 2 && !!permission["18_6"]) ||
                      roleId == 1) && (
                      <Link to="/group/country/add" className="btn btn-primary">
                        Add New Group
                      </Link>
                    )}
                  </div>
