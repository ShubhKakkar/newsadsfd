...
const searchQueryHandler = (
  ...
  return `group/all/customer?page=${page}&per_page=${per_page}&sortBy=${sortBy}&order=${order}&isActive=${isActive}&name=${name}&members=${members}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
};
...
const ViewAll = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Customer Groups - Noonmar";
  }, [records_per_page]);
